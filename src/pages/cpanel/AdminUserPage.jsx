...
export default function AdminUserPage() {
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex gap-2">
            ...
            <button
              onClick={() => handleDelete(row.original.$id, row.original.photoId)}
  ...
  const getInitialUserData = async () => {
    try {
      ...
      const removeAdmin = res.documents.filter((user) => user.name !== 'admin');
      setData(removeAdmin);
    } catch (error) {
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4">
              ...
              {editUser === null && (
                <div>
                  <input
                    ...
                    className="border p-2 rounded max-w-sm bg-gray-300"
                  />
                  {preview && (
                    <img src={preview} alt="Preview" className="w-16 h-16 rounded-full mt-2" />
                  )}
                </div>
              )}
              ...
              <div className="flex justify-end gap-2 mt-2">
                <button
                  ...
                  className="px-4 py-2 border rounded hover:bg-red-600"
                >
                  Batal
                </button>
                <button
